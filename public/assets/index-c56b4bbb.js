    ...
    return caseReducers.reduce(function(previousState, caseReducer) {
      if (caseReducer) {
        if (r(previousState)) {
          ...
          return createNextState3(previousState, function(draft2) {
...
function getUrlBasedHistory(getLocation, createHref, validateLocation, options) {
  ...
  let history = {
    ...
    listen(fn3) {
      ...
      window2.addEventListener(PopStateEventType$1, handlePop);
      listener = fn3;
      return () => {
        window2.removeEventListener(PopStateEventType$1, handlePop);
        listener = null;
      };
    },
    createHref(to) {
...
function createRouter(init) {
  ...
  async function startRedirectNavigation(state2, redirect, _temp) {
    ...
    if (redirectPreserveMethodStatusCodes.has(redirect.status) && submission && isMutationMethod(submission.formMethod)) {
      await startNavigation(redirectHistoryAction, redirectLocation, {
        submission: _extends$3({}, submission, {
  ...
  function getBlocker(key, fn3) {
    let blocker = state.blockers.get(key) || IDLE_BLOCKER;
    if (blockerFunctions.get(key) !== fn3) {
      blockerFunctions.set(key, fn3);
    }
    return blocker;
  }
...
function getMatchesToLoad(history, state, matches, submission, location, isRevalidationRequired, cancelledDeferredRoutes, cancelledFetcherLoads, fetchLoadMatches, routesToUse, basename, pendingActionData, pendingError) {
  ...
  fetchLoadMatches.forEach((f2, key) => {
    ...
    let shouldRevalidate = shouldRevalidateLoader(fetcherMatch, _extends$3({
      currentUrl,
...
function stripHashFromPath(path) {
  ...
  return createPath$1(_extends$3({}, parsedPath, {
    hash: ""
  }));
}
...
function RouterProvider(_ref) {
  ...
  let [state, setState] = reactExports.useState(router.state);
  ...
  return /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, /* @__PURE__ */ reactExports.createElement(DataRouterContext.Provider, {
    ...
    value: state
  }, /* @__PURE__ */ reactExports.createElement(Router$1, {
...
var createSelectors = function createSelectors2(structure2) {
  ...
  var getRouter = function getRouter2(state) {
  ...
  var getLocation = function getLocation2(state) {
    return toJS2(getIn3(getRouter(state), ["location"]));
  };
  var getAction = function getAction2(state) {
    return toJS2(getIn3(getRouter(state), ["action"]));
  };
  var getSearch = function getSearch2(state) {
    return toJS2(getIn3(getRouter(state), ["location", "search"]));
  };
  var getHash = function getHash2(state) {
    return toJS2(getIn3(getRouter(state), ["location", "hash"]));
  };
  var createMatchSelector = function createMatchSelector2(path) {
    var lastPathname = null;
    var lastMatch = null;
    return function(state) {
      var _ref = getLocation(state) || {}, pathname = _ref.pathname;
...
function useUncontrolled(props, config2) {
  return Object.keys(config2).reduce(function(result, fieldName) {
    var _extends2;
    var _ref = result, defaultValue = _ref[defaultKey(fieldName)], propsValue = _ref[fieldName], rest = _objectWithoutPropertiesLoose$9(_ref, [defaultKey(fieldName), fieldName].map(_toPropertyKey));
...
const Collapse = /* @__PURE__ */ React.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(TransitionWrapper$1, {
    ...
    children: (state, innerProps) => /* @__PURE__ */ React.cloneElement(children, {
      ...innerProps,
      className: cn(className, children.props.className, collapseStyles[state], computedDimension === "width" && "collapse-horizontal")
    })
  });
});
...
const AccordionContext = context$4;
const AccordionCollapse = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Collapse$1, {
    ...
    ...props,
    className: cn(className, bsPrefix),
...
const AccordionItemContext = context$3;
const AccordionBody = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  const {
    eventKey
  } = reactExports.useContext(AccordionItemContext);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionCollapse$1, {
    eventKey,
    onEnter,
    onEntering,
    onEntered,
...
function useAccordionButton(eventKey, onClick) {
  ...
  return (e2) => {
    ...
    if (alwaysOpen) {
      if (Array.isArray(activeEventKey)) {
        if (activeEventKey.includes(eventKey)) {
          eventKeyPassed = activeEventKey.filter((k2) => k2 !== eventKey);
        } else {
    ...
    onSelect == null ? void 0 : onSelect(eventKeyPassed, e2);
...
const AccordionButton = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
    ...
    className: cn(className, bsPrefix, !isAccordionItemSelected(activeEventKey, eventKey) && "collapsed")
  });
});
...
const AccordionHeader = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
    ...
    ...props,
    className: cn(className, bsPrefix),
    children: /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionButton$1, {
      onClick,
      children
    })
  });
...
const AccordionItem = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionItemContext.Provider, {
    value: contextValue,
    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
      ref,
      ...props,
...
const Accordion = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContext.Provider, {
    value: contextValue,
    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
      ref,
      ...controlledProps,
      className: cn(className, prefix, flush && `${prefix}-flush`)
    })
  });
});
...
const Button$2 = /* @__PURE__ */ reactExports.forwardRef((_ref, ref) => {
  let {
    as: asProp,
    disabled
  } = _ref, props = _objectWithoutPropertiesLoose$8(_ref, _excluded$8);
  const [buttonProps, {
    tagName: Component
...
const Anchor = /* @__PURE__ */ reactExports.forwardRef((_ref, ref) => {
  let {
    onKeyDown
  } = _ref, props = _objectWithoutPropertiesLoose$7(_ref, _excluded$7);
...
const Fade = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(TransitionWrapper$1, {
    ...
    children: (status, innerProps) => /* @__PURE__ */ reactExports.cloneElement(children, {
      ...innerProps,
      className: cn("fade", className, children.props.className, fadeStyles[status], transitionClasses[status])
    })
  });
});
...
const CloseButton = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  ref,
  type: "button",
  className: cn("btn-close", variant && `btn-close-${variant}`, className),
...
const divWithClassName = (className) => /* @__PURE__ */ reactExports.forwardRef((p2, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
  ...p2,
  ref,
  className: cn(p2.className, className)
}));
var rHyphen = /-(.)/g;
...
function createWithBsPrefix(prefix, {
  ...
  const BsComponent = /* @__PURE__ */ reactExports.forwardRef(({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, {
      ref,
      className: cn(className, resolvedPrefix),
      ...componentProps
    });
  });
...
const Alert = /* @__PURE__ */ reactExports.forwardRef((uncontrolledProps, ref) => {
  ...
  const handleClose = useEventCallback((e2) => {
    if (onClose) {
      onClose(false, e2);
    }
  });
  ...
  const alert = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    ref,
    className: cn(className, prefix, variant && `${prefix}-${variant}`, dismissible && `${prefix}-dismissible`),
...
const Badge = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
    ref,
    ...props,
    className: cn(className, prefix, pill && `rounded-pill`, text && `text-${text}`, bg2 && `bg-${bg2}`)
  });
});
...
const Button = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
    ...
    ref,
    disabled,
    className: cn(className, prefix, active && "active", variant && `${prefix}-${variant}`, size2 && `${prefix}-${size2}`, props.href && disabled && "disabled")
  });
});
...
const CardHeaderContext = context$2;
...
function useWillUnmount(fn3) {
  var onUnmount = useUpdatedRef(fn3);
  reactExports.useEffect(function() {
    return function() {
...
function setChainedTimeout(handleRef, fn3, timeoutAtMs) {
  ...
  handleRef.current = delayMs <= MAX_DELAY_MS ? setTimeout(fn3, delayMs) : setTimeout(function() {
    return setChainedTimeout(handleRef, fn3, timeoutAtMs);
  }, MAX_DELAY_MS);
}
function useTimeout() {
...
function useCol({
  ...
  return [{
    ...props,
    className: cn(className, ...spans, ...classes)
  }, {
    as,
    bsPrefix,
    spans
...
const Col = /* @__PURE__ */ reactExports.forwardRef(
  ...
  (props, ref) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
      ...colProps,
      ref,
      className: cn(className, !spans.length && bsPrefix)
    });
  }
);
Col.displayName = "Col";
...
function useUncontrolledProp(propValue, defaultValue, handler) {
  ...
  return [isProp ? propValue : stateValue, reactExports.useCallback((value, ...args) => {
    if (handler)
      handler(value, ...args);
    setState(value);
  }, [handler])];
...
function usePopper(referenceElement, popperElement, _ref = {}) {
  ...
  } = _ref, config2 = _objectWithoutPropertiesLoose$6(_ref, _excluded$6);
...
function useClickOutside(ref, onClickOutside = noop$4, {
  ...
  const handleMouseCapture = reactExports.useCallback((e2) => {
    const currentTarget = getRefTarget(ref);
    preventMouseClickOutsideRef.current = !currentTarget || isModifiedEvent$1(e2) || !isLeftClickEvent(e2) || !!contains(currentTarget, e2.target) || waitingForTrigger.current;
  ...
  reactExports.useEffect(() => {
    ...
    if ("ontouchstart" in doc.documentElement) {
      mobileSafariHackListeners = [].slice.call(doc.body.children).map((el2) => listen(el2, "mousemove", noop$4));
    }
    return () => {
...
function useDropdownMenu(options = {}) {
  const context2 = reactExports.useContext(DropdownContext$2);
  ...
  const handleClose = (e2) => {
    context2 == null ? void 0 : context2.toggle(false, e2);
  };
  const {
    placement,
    setMenu,
  ...
  const popper2 = usePopper(toggleElement, menuElement, mergeOptionsWithPopperConfig({
...
function DropdownMenu$2(_ref) {
  let {
    children
  } = _ref, options = _objectWithoutPropertiesLoose$5(_ref, _excluded$5);
...
DropdownMenu$2.defaultProps = defaultProps;
...
const isRoleMenu = (el2) => {
  var _el$getAttribute;
  return ((_el$getAttribute = el2.getAttribute("role")) == null ? void 0 : _el$getAttribute.toLowerCase()) === "menu";
};
const noop$2 = () => {
};
function useDropdownToggle() {
  const id2 = $704cf1d3b684cc5c$export$619500959fc48b26();
  const {
    show = false,
    toggle = noop$2,
    setToggle,
    menuElement
  } = reactExports.useContext(DropdownContext$2) || {};
  const handleClick = reactExports.useCallback((e2) => {
    toggle(!show, e2);
  }, [show, toggle]);
  const props = {
    id: id2,
...
function Dropdown$2({
  ...
  useEventListener(reactExports.useCallback(() => window2.document, [window2]), "keydown", (event) => {
    ...
    switch (key) {
      ...
      case "ArrowDown":
        ...
        return;
      case "Tab":
        addEventListener(target.ownerDocument, "keyup", (e2) => {
          var _menuRef$current2;
          if (e2.key === "Tab" && !e2.target || !((_menuRef$current2 = menuRef.current) != null && _menuRef$current2.contains(e2.target))) {
            onToggle(false, meta);
          }
        }, {
          once: true
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SelectableContext.Provider, {
    value: handleSelect,
    children: /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownContext$2.Provider, {
      value: context2,
      children
    })
  });
...
const DropdownContext$1 = DropdownContext;
const DropdownItem = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
    ...
    ...dropdownItemProps,
    ref,
    className: cn(className, prefix, meta.isActive && "active", disabled && "disabled")
  });
});
...
const InputGroupContext = context$1;
...
const DropdownMenu = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
    ...
    className: cn(className, prefix, show && "show", alignEnd && `${prefix}-end`, variant && `${prefix}-${variant}`, ...alignClasses)
  });
});
...
const DropdownToggle = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  const dropdownContext = reactExports.useContext(DropdownContext$2);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
    className: cn(className, prefix, split && `${prefix}-split`, (dropdownContext == null ? void 0 : dropdownContext.show) && "show"),
    ...toggleProps,
    ...props
  });
});
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownContext$1.Provider, {
    ...
    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Dropdown$2, {
      ...
      children: isInputGroup ? props.children : /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
        ...props,
        ref,
        className: cn(className, show && "show", directionClasses[drop])
      })
    })
  });
});
...
const Feedback = /* @__PURE__ */ reactExports.forwardRef(
  ...
  ({
    ...
    ...props,
    ref,
    className: cn(className, `${type}-${tooltip ? "tooltip" : "feedback"}`)
  })
);
...
const FormCheckInput = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
    ...
    type,
    id: id2 || controlId,
    className: cn(className, bsPrefix, isValid && "is-valid", isInvalid && "is-invalid")
  });
});
...
const FormCheck = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(FormContext$1.Provider, {
    ...
    children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
      style: style2,
      className: cn(className, hasLabel && bsPrefix, inline && `${bsPrefix}-inline`, reverse && `${bsPrefix}-reverse`, type === "switch" && bsSwitchPrefix),
...
const FormControl = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
    ...
    readOnly: readOnly2,
    id: id2 || controlId,
    className: cn(className, classes, isValid && `is-valid`, isInvalid && `is-invalid`, type === "color" && `${bsPrefix}-color`)
  });
});
...
const FormLabel = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  const classes = cn(className, bsPrefix, visuallyHidden && "visually-hidden", column && columnClass);
  htmlFor = htmlFor || controlId;
  if (column)
...
const FormSelect = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("select", {
    ...
    size: htmlSize,
    ref,
    className: cn(className, bsPrefix, size2 && `${bsPrefix}-${size2}`, isValid && `is-valid`, isInvalid && `is-invalid`),
    id: id2 || controlId
  });
});
...
const FormText = /* @__PURE__ */ reactExports.forwardRef(
  ...
  ({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
      ...props,
      ref,
      className: cn(className, bsPrefix, muted && "text-muted")
    });
  }
);
...
const Form = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  ...props,
  ref,
  className: cn(className, validated && "was-validated")
}));
...
const Container = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
    ref,
    ...props,
    className: cn(className, fluid ? `${prefix}${suffix}` : prefix)
  });
});
...
class ModalManager {
  ...
  setContainerStyle(containerState) {
    ...
    if (containerState.scrollBarWidth) {
      style2[paddingProp] = `${parseInt(style$1(container, paddingProp) || "0", 10) + containerState.scrollBarWidth}px`;
    }
    container.setAttribute(OPEN_DATA_ATTRIBUTE, "");
    style$1(container, style2);
  }
  reset() {
...
const Modal$2 = /* @__PURE__ */ reactExports.forwardRef((_ref, ref) => {
  ...
  const handleDocumentKeyDown = useEventCallback((e2) => {
    if (keyboard && isEscKey(e2) && modal.isTopModal()) {
...
const ModalDialog = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
    ...props,
    ref,
    className: cn(dialogClass, className, size2 && `${bsPrefix}-${size2}`, centered && `${dialogClass}-centered`, scrollable && `${dialogClass}-scrollable`, fullscreen && fullScreenClass),
    children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
      className: cn(`${bsPrefix}-content`, contentClassName),
      children
    })
  });
});
...
const AbstractModalHeader = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ref,
    ...props,
    children: [children, closeButton2 && /* @__PURE__ */ jsxRuntimeExports.jsx(CloseButton$1, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick
    })]
...
const Modal = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  const handleMouseUp = (e2) => {
    if (waitingForMouseUpRef.current && modal && e2.target === modal.dialog) {
  ...
  const handleClick = (e2) => {
    ...
    if (ignoreBackdropClickRef.current || e2.target !== e2.currentTarget) {
  ...
  const renderBackdrop = reactExports.useCallback((backdropProps) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
    ...backdropProps,
    className: cn(`${bsPrefix}-backdrop`, backdropClassName, !animation && "show")
  ...
  const renderDialog = (dialogProps) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
    ...
    className: cn(className, bsPrefix, animateStaticModal && `${bsPrefix}-static`, !animation && "show"),
...
const NavLink = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
    ...
    ref,
    disabled,
    className: cn(className, bsPrefix, disabled && "disabled", meta.isActive && "active")
  });
});
...
const NavDropdown = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Dropdown$1, {
    ref,
    ...props,
    className: cn(className, navItemPrefix),
...
const NavDropdown$1 = Object.assign(NavDropdown, {
...
function useRootClose(ref, onRootClose, {
  ...
  reactExports.useEffect(() => {
    ...
    const removeKeyupListener = listen(doc, "keyup", (e2) => {
      if (e2 === currentEvent) {
        currentEvent = void 0;
        return;
      }
...
const Overlay$2 = /* @__PURE__ */ reactExports.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
  ...
  const popper2 = usePopper(target, rootElement, mergeOptionsWithPopperConfig({
    placement,
...
Overlay$2.displayName = "Overlay";
const PopoverHeader = createWithBsPrefix("popover-header");
const PopoverBody = createWithBsPrefix("popover-body");
...
const Popover = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    className: cn(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
    children: [/* @__PURE__ */ jsxRuntimeExports.jsx("div", {
...
const Popover$1 = Object.assign(Popover, {
...
function useOverlayOffset(customOffset) {
  ...
  const offset2 = reactExports.useMemo(() => ({
    name: "offset",
    options: {
      offset: () => {
...
function wrapRefs(props, arrowProps) {
  ...
  props.ref = ref.__wrapped || (ref.__wrapped = (r2) => ref(safeFindDOMNode(r2)));
  arrowProps.ref = aRef.__wrapped || (aRef.__wrapped = (r2) => aRef(safeFindDOMNode(r2)));
}
const Overlay = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  const actualTransition = transition === true ? Fade$1 : transition || void 0;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Overlay$2, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
    ...
    children: (overlayProps, {
      ...
      return /* @__PURE__ */ reactExports.cloneElement(overlay, {
        ...
        popper: popper2,
        hasDoneInitialMeasure,
        className: cn(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
function handleMouseOverOut(handler, args, relatedNative) {
  ...
  const related = e2.relatedTarget || e2.nativeEvent[relatedNative];
...
function OverlayTrigger({
  ...
  const triggerNodeRef = reactExports.useRef(null);
  const mergedRef = useMergedRefs(triggerNodeRef, children.ref);
  const timeout = useTimeout();
  const hoverStateRef = reactExports.useRef("");
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? reactExports.Children.only(children).props : {};
  const attachRef = (r2) => {
    mergedRef(safeFindDOMNode(r2));
  };
  ...
  const handleFocus = reactExports.useCallback((...args) => {
    handleShow();
    onFocus == null ? void 0 : onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = reactExports.useCallback((...args) => {
    handleHide();
    onBlur == null ? void 0 : onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = reactExports.useCallback((...args) => {
    setShow(!show);
    onClick == null ? void 0 : onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = reactExports.useCallback((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = reactExports.useCallback((...args) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : /* @__PURE__ */ reactExports.cloneElement(children, triggerProps), /* @__PURE__ */ jsxRuntimeExports.jsx(Overlay$1, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
const Row = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
    ref,
    ...props,
    className: cn(className, decoratedBsPrefix, ...classes)
  });
});
Row.displayName = "Row";
const Row$1 = Row;
const Spinner = /* @__PURE__ */ reactExports.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
    ref,
    ...props,
    className: cn(className, bsSpinnerPrefix, size2 && `${bsSpinnerPrefix}-${size2}`, variant && `text-${variant}`)
  });
});
Spinner.displayName = "Spinner";
const Spinner$1 = Spinner;
const Table$1 = /* @__PURE__ */ reactExports.forwardRef(({
  bsPrefix,
  className,
  striped,
  bordered,
  ...
  const classes = cn(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size2 && `${decoratedBsPrefix}-${size2}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
...
const BootstrapTable = Table$1;
const computeActionName$8 = (actionName) => `common/${actionName}`;
const setUser = createAction(computeActionName$8("setUser"));
const setErrorsMessage = createAction(
  computeActionName$8("setErrorsMessage")
);
const cleanErrors = createAction(computeActionName$8("cleanErrors"));
const addAlertsSettings = createAction(
  computeActionName$8("addAlertsSettings")
);
const cleanAlertsSettings = createAction(computeActionName$8("cleanAlertsSettings"));
const addModalSettings = createAction(
  computeActionName$8("addModalSettings")
);
const cleanModalSettings = createAction(computeActionName$8("cleanModalSettings"));
const actions$8 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  addAlertsSettings,
  addModalSettings,
  cleanAlertsSettings,
...
const common = createReducer(initialState$8, (builder) => {
  builder.addCase(setUser, (state, { payload }) => {
    ...
    state.alertsSettingsList.push(payload);
...
var AccessLevels = /* @__PURE__ */ ((AccessLevels2) => {
  AccessLevels2["User"] = "user";
  AccessLevels2["Admin"] = "admin";
  return AccessLevels2;
})(AccessLevels || {});
var InternalRoutes = /* @__PURE__ */ ((InternalRoutes2) => {
  InternalRoutes2["Admin"] = "/admin/";
  InternalRoutes2["Login"] = "/login/";
  InternalRoutes2["Logout"] = "/logout/";
  InternalRoutes2["Main"] = "/";
  return InternalRoutes2;
})(InternalRoutes || {});
const selectCommonState = (state) => state.common;
const selectIsAdmin = (state) => {
  var _a;
  return ((_a = selectCommonState(state).user) == null ? void 0 : _a.accessLevel) === AccessLevels.Admin;
};
const selectUser = (state) => selectCommonState(state).user;
const selectErrorsMessagesList = (state) => selectCommonState(state).errors.messagesList;
const selectAlertsSettingsList = (state) => selectCommonState(state).alertsSettingsList;
const selectModalSettingsList = (state) => selectCommonState(state).modalSettingsList;
  ...
  (function() {
    ...
    var runInContext = function runInContext2(context2) {
      ...
      function createBind(func, bitmask, thisArg) {
        ...
        function wrapper2() {
          var fn3 = this && this !== root && this instanceof wrapper2 ? Ctor : func;
      ...
      function createPartial(func, bitmask, thisArg, partials) {
        var isBind = bitmask & WRAP_BIND_FLAG, Ctor = createCtor(func);
        function wrapper2() {
          var argsIndex = -1, argsLength = arguments.length, leftIndex = -1, leftLength = partials.length, args = Array2(leftLength + argsLength), fn3 = this && this !== root && this instanceof wrapper2 ? Ctor : func;
          while (++leftIndex < leftLength) {
...
const isObject = (value) => Boolean(Boolean(value) && typeof value === "object" && !Array.isArray(value));
const isArray = (value) => Boolean(value && Array.isArray(value));
const EMAIL_REGEX = /.+@.+\..+/;
const forEachKey = (data, callback) => Object.entries(data).reduce((r2, [name, value]) => {
  r2[callback(name)] = isObject(value) || isArray(value) ? forEachKey(value, callback) : value;
  return r2;
}, isObject(data) ? {} : []);
const stopPropagation = (e2) => e2.stopPropagation();
const preventDefault = (e2) => e2.preventDefault();
const checkEmailValidity = (email) => EMAIL_REGEX.test(email);
const getPromiseAndResRej = () => {
  let _resolve = lodashExports.noop;
  let _reject = lodashExports.noop;
  return {
...
const computeHeaders = (headers) => Object.entries(headers).reduce((result, [key, value]) => {
  result.append(key, value);
  return result;
}, new Headers());
const toCamelCase = (data) => forEachKey(data, lodashExports.camelCase);
const getJSONHeaders = () => ({ "Content-Type": "application/json" });
const computeApiPathWithDomain = (domain, path) => `/api/${domain}/${path}`;
const isErrorResponse = (d2) => isObject(d2) && ("message" in d2 && Object.keys(d2).length === 1 || "message" in d2 && "errors" in d2);
const getStore = () => window.store;
const setStore = (store) => window.store = store;
var BuiltInHeaders = /* @__PURE__ */ ((BuiltInHeaders2) => {
  BuiltInHeaders2["JSON"] = "json";
  return BuiltInHeaders2;
})(BuiltInHeaders || {});
const computeHeadersObject = (headers) => {
  var _a;
  return !headers ? headers : computeHeaders({
    ...((_a = headers.builtIn) == null ? void 0 : _a.includes("json")) && getJSONHeaders(),
    ...headers.custom && headers.custom
  });
};
const computeOptions = (options) => !options ? options : {
  ...options,
...
const call = ({ url, options, resultType = "json" }) => fetch(url, computeOptions(options)).then((d2) => d2[resultType]()).then((d2) => {
  if (isErrorResponse(d2)) {
    getStore().dispatch(setErrorsMessage(d2.message));
    return Promise.reject(d2.message);
  }
  return d2;
}).then((r2) => isObject(r2) || isArray(r2) ? toCamelCase(r2) : r2);
const computePath$6 = computeApiPathWithDomain.bind(null, "responsiblePersons");
const computeEmailPath = computeApiPathWithDomain.bind(null, "emailSender");
const Methods$6 = {
  GetAll: computePath$6("getAll"),
  Write: computePath$6("write")
};
const EmailMethods = {
  SendTestEmail: computeEmailPath("sendTestEmail")
};
const writeResponsiblePerson = (responsiblePerson) => call({
  url: Methods$6.Write,
  options: {
    method: "POST",
...
const getResponsiblePersonArray = () => call({ url: Methods$6.GetAll });
const sendTestEmail$1 = (email) => call({
...
const computeActionName$7 = (actionName) => `responsiblePersons/${actionName}`;
const setResponsiblePersonsArray = createAction(
  computeActionName$7("setResponsiblePersonsArray")
);
const setResponsiblePerson = createAction(computeActionName$7("setResponsiblePerson"));
const downloadResponsiblePersonsArray = createAppAsyncThunk(
  computeActionName$7("downloadResponsiblePersonsArray"),
  (_2, { dispatch }) => getResponsiblePersonArray().then((d2) => {
    dispatch(setResponsiblePersonsArray(d2));
  })
);
const uploadResponsiblePerson = createAppAsyncThunk(
  computeActionName$7("uploadResponsiblePerson"),
  (responsiblePerson, { dispatch }) => writeResponsiblePerson(responsiblePerson).then((d2) => {
    dispatch(setResponsiblePerson(d2));
  })
);
const sendTestEmail = createAppAsyncThunk(
  computeActionName$7("sendTestEmail"),
  (email) => sendTestEmail$1(email)
);
const actions$7 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  downloadResponsiblePersonsArray,
  sendTestEmail,
  setResponsiblePerson,
  setResponsiblePersonsArray,
  uploadResponsiblePerson
}, Symbol.toStringTag, { value: "Module" }));
const computePath$5 = computeApiPathWithDomain.bind(null, "citiesPrefix");
const Methods$5 = {
  GetAll: computePath$5("getAll"),
  Add: computePath$5("add"),
  Delete: computePath$5("delete")
};
const addCityPrefix = (data) => call({
  url: Methods$5.Add,
  options: {
    method: "POST",
    body: data,
...
const removeCityPrefix = (data) => call({
  url: Methods$5.Delete,
  options: {
    method: "POST",
    body: data,
    headers: { builtIn: [BuiltInHeaders.JSON] }
...
const getAllCitiesPrefixes = () => call({ url: Methods$5.GetAll });
const selectCitiesPrefixEditState = (state) => state.$citiesPrefixEdit;
const selectCities = (state) => selectCitiesPrefixEditState(state).cities;
const selectNewCityName = (state) => selectCitiesPrefixEditState(state).newCityName;
const selectNewCityPrefix = (state) => selectCitiesPrefixEditState(state).newCityPrefix;
const selectShowNewCityForm = (state) => selectCitiesPrefixEditState(state).showNewCityForm;
const computeActionName$6 = (actionName) => `citiesPrefixEdit/${actionName}`;
const setCities = createAction(computeActionName$6("setCities"));
const setNewCityName = createAction(computeActionName$6("setNewCityName"));
const setNewCityPrefix = createAction(computeActionName$6("setNewCityPrefix"));
const setShowNewCityForm = createAction(computeActionName$6("setShowNewCityForm"));
const downloadCities = createAppAsyncThunk(
  computeActionName$6("downloadCities"),
  async (_2, { dispatch }) => {
    const cities = await getAllCitiesPrefixes();
    dispatch(setCities(cities));
  }
);
const saveNewCityItem = createAppAsyncThunk(
  computeActionName$6("saveNewCityItem"),
  (_2, { getState, dispatch }) => {
    ...
    if (name && prefix) {
      ...
      return addCityPrefix({ prefix, name }).then((cities) => dispatch(setCities(cities))).then(() => dispatch(downloadResponsiblePersonsArray()));
    }
    return void 0;
  }
);
const deleteCity = createAppAsyncThunk(
  computeActionName$6("deleteCity"),
  (cityToRemove, { dispatch }) => removeCityPrefix({ prefix: cityToRemove[1] }).then((d2) => {
    dispatch(setCities(d2));
    void dispatch(downloadResponsiblePersonsArray());
  })
);
const actions$6 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  deleteCity,
  downloadCities,
  saveNewCityItem,
...
const initialState$7 = { cities: null, newCityName: "", newCityPrefix: "", showNewCityForm: false };
const $citiesPrefixEdit = createReducer(initialState$7, (builder) => {
  builder.addCase(setCities, (state, { payload }) => {
...
const AddItemButton = () => {
  const cityPrefixInputRef = reactExports.useRef(null);
  const popoverBodyRef = reactExports.useRef(null);
  const { setNewCityPrefix: setNewCityPrefix2, setNewCityName: setNewCityName2, saveNewCityItem: saveNewCityItem2, setShowNewCityForm: setShowNewCityForm2 } = useActions(actions$6);
  ...
  useWindowEvent("click", (e2) => {
    var _a;
    if (((_a = popoverBodyRef.current) == null ? void 0 : _a.parentElement) && showNewCityForm && e2.target && !popoverBodyRef.current.parentElement.contains(e2.target)) {
      setShowNewCityForm2(false);
    }
  });
  useWindowEvent("keyup", (e2) => {
    if (showNewCityForm && cityPrefix && cityName) {
      switch (e2.code) {
        case "Enter":
          void saveNewCityItem2();
          return;
        case "Escape":
          setShowNewCityForm2(false);
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    OverlayTrigger,
    {
      ...
      trigger: "click",
      onToggle: () => setShowNewCityForm2(!showNewCityForm),
      placement: "left",
      overlay: /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover$1, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Popover$1.Header, { as: "h3", children: "Новый город" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Popover$1.Body, { ref: popoverBodyRef, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1, { className: "d-flex flex-column gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Row$1, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Form$1.Control,
              {
                ref: cityPrefixInputRef,
                placeholder: "Префикс",
                value: cityPrefix,
                onChange: (e2) => setNewCityPrefix2(e2.target.value)
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Form$1.Control, { placeholder: "Имя", value: cityName, onChange: (e2) => setNewCityName2(e2.target.value) }) })
          ] }),
          cityName && cityPrefix && /* @__PURE__ */ jsxRuntimeExports.jsx(Row$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { onClick: () => void saveNewCityItem2(), variant: "success", children: "Сохранить" }) }) })
        ] }) })
      ] }),
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { variant: "success", onClick: stopPropagation, children: "Добавить ещё" })
    }
  );
};
const closeButton = "_closeButton_1dygb_1";
const css$7 = {
  closeButton
};
const CityBadge = ({ cityPrefix, cityName, onClose, bg: bg2 = "primary" }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge$1, { bg: bg2, className: "p-4 position-relative", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h6 m-0", children: `${cityPrefix.toUpperCase()} => ${cityName}` }),
  onClose && /* @__PURE__ */ jsxRuntimeExports.jsx(
    CloseButton$1,
    {
      className: cn(css$7.closeButton, "position-absolute"),
      variant: "white",
...
const CitiesList = () => {
  ...
  const { deleteCity: deleteCity2 } = useActions(actions$6);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "d-flex gap-3 flex-wrap", children: cities.map(([cityName, cityPrefix]) => /* @__PURE__ */ jsxRuntimeExports.jsx(CityBadge, { onClose: (c2) => void deleteCity2(c2), cityName, cityPrefix })) });
};
const Layout$4 = () => {
  const storeCities = useSelector(selectCities);
  const { downloadCities: downloadCities2 } = useActions(actions$6);
  useInitDownloadData({ data: storeCities, downloadFn: downloadCities2 });
  if (!storeCities)
    return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex flex-column gap-4 flex-d", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CitiesList, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "d-flex justify-content-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AddItemButton, {}) })
  ] });
};
const Mark = ({ className }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "svg",
  {
    className,
    ...
    fill: "currentColor",
    viewBox: "0 0 16 16",
    children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z" })
  }
);
...
const Icon = ({ type, className }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(IconSvg, { className });
};
const icon = "_icon_g5i36_1";
const button = "_button_g5i36_6";
const valueWrapper = "_valueWrapper_g5i36_11";
const closeButtonContent = "_closeButtonContent_g5i36_15";
const css$6 = {
  icon,
  button,
  valueWrapper,
...
const EditableField = ({ value, onAccept, onDelete }) => {
  const inputRef = reactExports.useRef(null);
  const [isLoading, setIsLoading] = reactExports.useState(false);
  const [isEditing, setIsEditing] = reactExports.useState(false);
  const [stateValue, setStateValue] = reactExports.useState(value);
  const onAcceptClick = () => {
    setIsEditing(false);
    if (stateValue !== value) {
      setIsLoading(true);
  ...
  const onDeleteClick = () => {
    void (onDelete == null ? void 0 : onDelete().catch(() => setIsLoading(false)));
  };
  const onRowWithValueClick = reactExports.useCallback(() => setIsEditing(true), []);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Row$1, { className: "h-100", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, { onClick: onRowWithValueClick, className: "d-flex align-items-center", children: isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      Form$1.Control,
      {
        ref: inputRef,
    ...
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: css$6.valueWrapper, children: value }) }),
    isEditing && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, { sm: "auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button$1,
        {
          variant: "success",
          title: "Сохранить",
          className: cn(css$6.button, "rounded-circle"),
          onClick: onAcceptClick,
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { type: "Mark", className: cn(css$6.icon, "text-white") })
        }
      ) }),
      onDelete && /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, { sm: "auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button$1,
        {
          variant: "danger",
          title: "Удалить",
          className: cn(css$6.button, "rounded-circle position-relative"),
          onClick: onDeleteClick,
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: css$6.closeButtonContent, children: "×" })
        }
      ) })
    ] })
  ] });
};
const computePath$4 = computeApiPathWithDomain.bind(null, "leftovers");
const Methods$4 = {
  Add: computePath$4("add"),
  Update: computePath$4("update"),
  WriteAll: computePath$4("writeAll"),
  DeleteOne: computePath$4("deleteOne"),
  DeleteAll: computePath$4("deleteAll"),
  GetAll: computePath$4("getAll"),
  GetUniqueProducts: computePath$4("getUniqueProducts")
};
const updateLeftover$1 = (leftover) => call({
  url: Methods$4.Update,
  options: {
    method: "POST",
    body: { leftover },
    headers: { builtIn: [BuiltInHeaders.JSON] }
...
const getLeftoversList$1 = () => call({ url: Methods$4.GetAll });
const deleteLeftoversList$1 = () => call({ url: Methods$4.DeleteAll });
const selectLeftoversTableState = (state) => state.$leftoversTable;
const selectLeftoversList = (state) => selectLeftoversTableState(state).leftoversList;
const computeActionName$5 = (actionName) => `leftovers/${actionName}`;
const setLeftoversList = createAction(computeActionName$5("setLeftoversList"));
const getLeftoversList = createAppAsyncThunk(
  computeActionName$5("getLeftoversList"),
  (_2, { dispatch }) => getLeftoversList$1().then((d2) => dispatch(setLeftoversList(d2)))
);
const updateLeftover = createAppAsyncThunk(
  computeActionName$5("updateLeftover"),
  (leftover, { dispatch, getState }) => updateLeftover$1(leftover).then((d2) => {
    const leftoversList = selectLeftoversList(getState());
    dispatch(
      setLeftoversList(
        leftoversList ? leftoversList.map((leftover2) => leftover2.cityName === d2.cityName ? d2 : leftover2) : [d2]
      )
    );
  })
);
const deleteLeftoversList = createAppAsyncThunk(
  computeActionName$5("getLeftoversList"),
  (_2, { dispatch }) => deleteLeftoversList$1().then((d2) => dispatch(setLeftoversList(d2)))
);
...
const $leftoversTable = createReducer(initialState$6, (builder) => {
  builder.addCase(setLeftoversList, (state, { payload }) => {
...
const haveToOrder = "_haveToOrder_cg0m7_1";
const css$5 = {
  haveToOrder
};
const computePath$3 = computeApiPathWithDomain.bind(null, "minimalLeftovers");
const Methods$3 = {
  GetAll: computePath$3("getAll"),
  WriteAll: computePath$3("writeAll"),
  Write: computePath$3("write"),
  DeleteAll: computePath$3("deleteAll"),
  Delete: computePath$3("delete")
};
const writeMinimalLeftover$1 = (minimalLeftover) => call({
  url: Methods$3.Write,
  options: {
    method: "POST",
...
const getMinimalLeftoversArray = () => call({ url: Methods$3.GetAll });
const deleteMinimalLeftoversList$1 = () => call({ url: Methods$3.DeleteAll });
const selectMinimalLeftoversState = (state) => state.$minimalLeftovers;
const selectMinimalLeftoversList = (state) => selectMinimalLeftoversState(state).minimalLeftoversArray;
const selectMinimalLeftoversListIsEmpty = (state) => {
  var _a;
  return (((_a = selectMinimalLeftoversState(state).minimalLeftoversArray) == null ? void 0 : _a.length) ?? 0) === 0;
};
const computeActionName$4 = (actionName) => `minimalLeftovers/${actionName}`;
const setMinimalLeftoversList = createAction(computeActionName$4("setMinimalLeftoversList"));
const setMinimalLeftover = createAction(computeActionName$4("setMinimalLeftover"));
const getMinimalLeftoversList = createAppAsyncThunk(
  computeActionName$4("getMinimalLeftoversList"),
  (_2, { dispatch }) => getMinimalLeftoversArray().then((d2) => dispatch(setMinimalLeftoversList(d2)))
);
const writeMinimalLeftover = createAppAsyncThunk(
  computeActionName$4("writeMinimalLeftover"),
  (minimalLeftover, { dispatch, getState }) => writeMinimalLeftover$1(minimalLeftover).then(
    (d2) => {
      var _a;
      return d2 ? dispatch(setMinimalLeftover(d2)) : dispatch(
        setMinimalLeftoversList(
          ((_a = selectMinimalLeftoversList(getState())) == null ? void 0 : _a.filter((it) => it.cityName !== minimalLeftover.cityName)) ?? []
        )
      );
    }
  ).then(() => dispatch(getLeftoversList()))
);
const deleteMinimalLeftoversList = createAppAsyncThunk(
  computeActionName$4("deleteMinimalLeftovers"),
  (_2, { dispatch }) => deleteMinimalLeftoversList$1().then((d2) => dispatch(setMinimalLeftoversList(d2)))
);
...
const initialState$5 = { minimalLeftoversArray: null, status: "idle" };
const $minimalLeftovers = createReducer(initialState$5, (builder) => {
  builder.addCase(setMinimalLeftoversList, (state, { payload }) => {
    state.minimalLeftoversArray = payload;
  }).addCase(setMinimalLeftover, (state, { payload }) => {
    if (state.minimalLeftoversArray) {
      state.minimalLeftoversArray = state.minimalLeftoversArray.map(
        (minimalLeftovers) => minimalLeftovers.cityName === payload.cityName ? payload : minimalLeftovers
      );
    } else {
      state.minimalLeftoversArray = [payload];
    }
...
const computeModalProps = ({ onAccept = lodashExports.noop, onDecline = lodashExports.noop } = {}) => ({
...
const Table = () => {
  ...
  const { writeMinimalLeftover: writeMinimalLeftover2 } = useActions(actions$4);
  const { addAlertsSettings: addAlertsSettings2, addModalSettings: addModalSettings2 } = useActions(actions$8);
  const onAcceptLeftoverChange = reactExports.useCallback(
    (product, minimalLeftovers) => writeMinimalLeftover2({
      cityName: minimalLeftovers.cityName,
      products: minimalLeftovers.products.map((p2) => p2.nomenclature === product.nomenclature ? product : p2)
    }).unwrap().then(() => addAlertsSettings2({ variant: "success", children: "Изменения сохранены" })),
    []
  );
  const onDeleteProduct = reactExports.useCallback((product, minimalLeftovers) => {
    const { promise: promise2, reject } = getPromiseAndResRej();
    addModalSettings2(
      computeModalProps({
        onAccept: () => {
          void writeMinimalLeftover2({
            cityName: minimalLeftovers.cityName,
            products: minimalLeftovers.products.filter((p2) => p2.nomenclature !== product.nomenclature)
          }).unwrap().then(() => addAlertsSettings2({ variant: "success", children: "Запись удалена" })).catch(reject);
        }
      })
    );
    return promise2;
  }, []);
  if (!minimalLeftoversArray)
    return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(BootstrapTable, { bordered: true, hover: true, size: "sm", className: "leftoverTable", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Минимальный Остаток" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Количество товара для заказа" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: minimalLeftoversArray.map((minimalLeftovers) => /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "align-middle", colSpan: 4, children: /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: minimalLeftovers.cityName }) }) }),
      minimalLeftovers.products.map((product) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "align-middle", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "", children: product.nomenclature }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "align-middle w-25", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          EditableField,
          {
            ...
            onAccept: (payload) => onAcceptLeftoverChange({ ...product, minimalLeftover: payload }, minimalLeftovers),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "align-middle w-25", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          EditableField,
          {
            ...
            onAccept: (payload) => onAcceptLeftoverChange({ ...product, orderingCount: payload }, minimalLeftovers),
            onDelete: () => onDeleteProduct(product, minimalLeftovers)
          }
        ) })
...
const Layout$3 = () => {
  ...
  const { getMinimalLeftoversList: getMinimalLeftoversList2 } = useActions(actions$4);
  useInitDownloadData({ data: minimalLeftoversList, downloadFn: getMinimalLeftoversList2 });
...
const computeDeleteModalProps = ({ onAccept = lodashExports.noop, onDecline = lodashExports.noop } = {}) => ({
  title: "Подтвердите действие",
...
const computeResponsibleNotifyModalProps = ({ onAccept = lodashExports.noop, onDecline = lodashExports.noop } = {}) => ({
  title: "Подтвердите действие",
...
const computePath$2 = computeApiPathWithDomain.bind(null, "file");
const Methods$2 = {
  Upload: computePath$2("upload"),
  DeleteExisting: computePath$2("deleteExisting"),
  GetFileInfo: computePath$2("getFileInfo"),
  AcceptFile: computePath$2("acceptFile")
};
const uploadFile$1 = (file) => {
  const body = new FormData();
  body.append("file", file);
  return call({
    url: Methods$2.Upload,
    options: {
      method: "POST",
      stringifyBody: false,
      body
...
const getFileInfo = () => call({ url: Methods$2.GetFileInfo });
const acceptFile$1 = (notify) => call({
  url: Methods$2.AcceptFile,
  options: {
    method: "POST",
    body: { notify },
    headers: { builtIn: [BuiltInHeaders.JSON] }
...
const computeActionName$3 = (actionName) => `citiesPrefixEdit/${actionName}`;
const setDate = createAction(computeActionName$3("setUploadDate"));
const uploadFile = createAppAsyncThunk(
  computeActionName$3("uploadFile"),
  (file, { dispatch }) => uploadFile$1(file).then(() => dispatch(getUploadDate()))
);
const getUploadDate = createAppAsyncThunk(
  computeActionName$3("getUploadDate"),
  (_2, { dispatch }) => getFileInfo().then(
    ({ uploadDate, lastUpdatedDate = null }) => dispatch(setDate({ uploadDate, lastUpdatedDate }))
  )
);
const acceptFile = createAppAsyncThunk(
  computeActionName$3("acceptFile"),
  (notify, { dispatch }) => acceptFile$1(notify).then(({ uploadDate, lastUpdatedDate = null }) => {
    dispatch(setDate({ uploadDate, lastUpdatedDate }));
    void dispatch(getMinimalLeftoversList());
    void dispatch(getLeftoversList());
  })
);
const deleteAllLeftovers = createAppAsyncThunk(
  computeActionName$3("deleteAllLeftovers"),
  async (_2, { dispatch }) => {
    await Promise.all([
      dispatch(deleteMinimalLeftoversList()),
      dispatch(deleteLeftoversList())
    ]);
  }
);
...
const initialState$4 = { uploadDate: null, lastUpdatedDate: null, fileUploadingState: "idle" };
const $fileUpload = createReducer(initialState$4, (builder) => {
  builder.addCase(setDate, (state, { payload }) => {
...
const selectFileUploadState = (state) => state.$fileUpload;
const selectFileUploadDate = (state) => selectFileUploadState(state).uploadDate;
const selectIsLastUpdatedEqualUploadDate = (state) => selectFileUploadState(state).lastUpdatedDate === selectFileUploadDate(state);
const selectIsFileUploading = (state) => selectFileUploadState(state).fileUploadingState === "uploading";
const FileUpload = reactExports.memo(() => {
  ...
  const { getUploadDate: getUploadDate2, uploadFile: uploadFile2, acceptFile: acceptFile2, deleteAllLeftovers: deleteAllLeftovers2 } = useActions(actions$3);
  const { addAlertsSettings: addAlertsSettings2, addModalSettings: addModalSettings2 } = useActions(actions$8);
  const onFormSubmit = reactExports.useCallback(
    (e2) => {
      e2.preventDefault();
      if (file)
        void uploadFile2(file).unwrap().then(() => {
          var _a;
          setFile(null);
          (_a = formRef.current) == null ? void 0 : _a.reset();
          addAlertsSettings2({ variant: "success", children: "Файл успешно загружен" });
        });
    },
    [file]
  );
  const onUpdateLeftoversClick = reactExports.useCallback(() => {
    const { promise: promise2, resolve } = getPromiseAndResRej();
    addModalSettings2(
    ...
    void promise2.then(
      (r2) => acceptFile2(r2).unwrap().then(() => addAlertsSettings2({ variant: "success", children: "Все остатки успешно обновлены" }))
    );
  }, []);
  const onFileAdd = reactExports.useCallback(({ target }) => {
    var _a;
    if (isObject(target) && "files" in target && ((_a = target.files) == null ? void 0 : _a[0])) {
      setFile(target.files[0]);
    }
  }, []);
  const onLeftoversDelete = reactExports.useCallback(() => {
    addModalSettings2(
      computeDeleteModalProps({
        onAccept: () => void deleteAllLeftovers2().unwrap().then(() => addAlertsSettings2({ variant: "success", children: "Все остатки успешно удалены" }))
      })
    );
  }, []);
  useInitDownloadData({ data: fileUploadDate, downloadFn: getUploadDate2 });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1, { ref: formRef, onSubmit: onFormSubmit, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1.Group, { controlId: "formFile", className: "mb-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Form$1.Label, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Загрузить можно .html файл (специально выгруженный из 1с)" }),
        formattedFileUploadDate && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          "Дата последней загрузки файла: ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: formattedFileUploadDate })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Form$1.Control, { onChange: onFileAdd, type: "file", accept: ".html" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { disabled: !file || isFileUploading, type: "submit", children: "Загрузить" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { variant: "danger", type: "button", disabled: isMinimalLeftoversListEmpty, onClick: onLeftoversDelete, children: "Удалить все остатки" })
    ] })
  ] });
});
const computePath$1 = computeApiPathWithDomain.bind(null, "config");
const Methods$1 = {
  GetEmailSettings: computePath$1("getEmailSettings"),
  WriteEmailSettings: computePath$1("writeEmailSettings")
};
const writeMailSettings = (writeMailSettingsRequest) => call({
  url: Methods$1.WriteEmailSettings,
  options: {
    method: "POST",
...
const getMailSettings = () => call({ url: Methods$1.GetEmailSettings });
const selectMailerSettings = (state) => state.$mailerSettings;
const selectIsUploading = (state) => selectMailerSettings(state).uploadingStatus === "loading";
const selectLocalMailerSettings = (state) => selectMailerSettings(state).localSettings;
const selectReceivedMailerSettings = (state) => selectMailerSettings(state).receivedSettings;
const selectIsAllDataReady = createSelector(
  selectLocalMailerSettings,
  selectReceivedMailerSettings,
  (local, received) => !received || local.password || Object.entries(received).some(([key, value]) => local[key] !== value)
);
const computeActionName$2 = (actionName) => `minimalLeftovers/${actionName}`;
const setLocalMailSettings = createAction(computeActionName$2("setLocalMailSettings"));
const setReceivedMailSettings = createAction(computeActionName$2("setReceivedMailSettings"));
const downloadMailSettings = createAppAsyncThunk(
  computeActionName$2("downloadMailSettings"),
  (_2, { dispatch }) => getMailSettings().then((d2) => {
    dispatch(setLocalMailSettings(d2));
    dispatch(setReceivedMailSettings(d2));
  })
);
const uploadMailSettings = createAppAsyncThunk(
  computeActionName$2("uploadMailSettings"),
  (_2, { dispatch, getState }) => {
    const state = getState();
    const settings = { ...selectReceivedMailerSettings(state), ...selectLocalMailerSettings(state) };
    return writeMailSettings(settings).then((d2) => {
      dispatch(setLocalMailSettings(d2));
      dispatch(setReceivedMailSettings(d2));
    });
  }
...
const $mailerSettings = createReducer(initialState$3, (builder) => {
  builder.addCase(setLocalMailSettings, (state, { payload }) => {
...
const FormField$1 = reactExports.memo(({ field, type, title, placeholder, colClassName }) => {
  const value = useSelector(selectLocalMailerSettings)[field];
  const { setLocalMailSettings: setLocalMailSettings2 } = useActions(actions$2);
  const isCheckbox = type === "checkbox";
  const Input = isCheckbox ? Form$1.Check : Form$1.Control;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1.Group, { as: Row$1, className: "mb-3", controlId: `input${field}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Form$1.Label, { column: true, sm: 2, children: title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, { sm: 10, className: colClassName, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Input,
      {
        type,
        placeholder,
        onChange: (e2) => setLocalMailSettings2({
          [field]: isCheckbox ? e2.target.checked : type === "number" ? +e2.target.value : e2.target.value
        }),
...
const Layout$2 = () => {
  ...
  const { downloadMailSettings: downloadMailSettings2, uploadMailSettings: uploadMailSettings2 } = useActions(actions$2);
  const { addAlertsSettings: addAlertsSettings2 } = useActions(actions$8);
  useInitDownloadData({ data: receivedMailerSettings, downloadFn: downloadMailSettings2 });
  const onSubmit = reactExports.useCallback((e2) => {
    e2.preventDefault();
    void uploadMailSettings2().unwrap().then(() => addAlertsSettings2({ variant: "success", children: "Данные сохранены" }));
  }, []);
  if (!receivedMailerSettings)
    return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1, { onSubmit, children: [
    FIELDS_MAP.map((props, i2) => /* @__PURE__ */ jsxRuntimeExports.jsx(FormField$1, { ...props }, i2)),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Form$1.Group, { as: Row$1, className: "mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, { sm: { span: 10, offset: 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { disabled: isUploading || !isAllDataReady, type: "submit", children: "Сохранить" }) }) })
  ] });
};
const initialState$2 = {
  responsiblePersonArray: null
};
const $responsiblePersons = createReducer(initialState$2, (builder) => {
  builder.addCase(setResponsiblePersonsArray, (state, { payload }) => {
    state.responsiblePersonArray = payload;
  }).addCase(setResponsiblePerson, (state, { payload }) => {
    if (state.responsiblePersonArray) {
      state.responsiblePersonArray = state.responsiblePersonArray.map(
        (p2) => p2.cityName === payload.cityName ? payload : p2
      );
    } else {
      state.responsiblePersonArray = [payload];
    }
...
const selectResponsiblePersons = (state) => state.$responsiblePersons;
const selectResponsiblePersonArray = (state) => selectResponsiblePersons(state).responsiblePersonArray;
const UserCreation = ({ person, onSave, className }) => {
  const [accountEmail, setAccountEmail] = reactExports.useState(person.accountEmail);
  const [accountPassword, setAccountPassword] = reactExports.useState("");
  const isEmailValid = checkEmailValidity(accountEmail);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1.Group, { as: Row$1, className, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Form$1.Label, { column: true, sm: 2, controlId: "inputEmail", children: "Данные для входа:" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, { sm: 4, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Form$1.Control,
      {
        type: "email",
        placeholder: "email",
        onChange: (e2) => setAccountEmail(e2.target.value),
        value: accountEmail
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, { sm: 4, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Form$1.Control,
      {
        ...
        onChange: (e2) => setAccountPassword(e2.target.value),
...
const NotificationEdit = ({ person, onSave, onTestEmail, className }) => {
  const [notificationEmail, setNotificationEmail] = reactExports.useState(person.notifyEmail);
  const isEmailValid = checkEmailValidity(notificationEmail);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1.Group, { as: Row$1, className, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Form$1.Label, { column: true, sm: 2, controlId: `input${person.cityName}`, children: "Почта для оповещений:" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, { sm: 4, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Form$1.Control,
      {
        type: "email",
        placeholder: "test@email.ru",
        onChange: (e2) => setNotificationEmail(e2.target.value),
        value: notificationEmail
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, { sm: 1, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button$1,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { variant: "success", disabled: !isEmailValid, onClick: () => onTestEmail(notificationEmail), children: "Выслать тестовое письмо" }) })
  ] });
};
const notifyField = "_notifyField_1wcu7_1";
const css$4 = {
  notifyField
};
const FormField = ({ person, onSave, onTestEmail }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex flex-column gap-2", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx(Form$1.Group, { as: Row$1, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Form$1.Label, { column: true, sm: 12, children: /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: person.cityName }) }) }, person.cityName),
  /* @__PURE__ */ jsxRuntimeExports.jsx(NotificationEdit, { onTestEmail, onSave, person, className: css$4.notifyField }),
  /* @__PURE__ */ jsxRuntimeExports.jsx(UserCreation, { person, onSave, className: css$4.notifyField })
] });
const Layout$1 = () => {
  const responsiblePersonArray = useSelector(selectResponsiblePersonArray);
  const { downloadResponsiblePersonsArray: downloadResponsiblePersonsArray2, uploadResponsiblePerson: uploadResponsiblePerson2, sendTestEmail: sendTestEmail2 } = useActions(actions$7);
  const { addAlertsSettings: addAlertsSettings2 } = useActions(actions$8);
  useInitDownloadData({ data: responsiblePersonArray, downloadFn: downloadResponsiblePersonsArray2 });
  const onSaveClick = reactExports.useCallback((responsiblePerson) => {
    void uploadResponsiblePerson2(responsiblePerson).unwrap().then(() => addAlertsSettings2({ variant: "success", children: "Запись успешна сохранена" }));
  }, []);
  const onTestEmailClick = reactExports.useCallback((email) => {
    void sendTestEmail2(email).unwrap().then(() => addAlertsSettings2({ variant: "success", children: "Сообщение отправлено" }));
  }, []);
  if (!responsiblePersonArray)
    return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Form$1, { className: "d-flex flex-column gap-3", children: responsiblePersonArray.map((person) => /* @__PURE__ */ jsxRuntimeExports.jsx(FormField, { onSave: onSaveClick, onTestEmail: onTestEmailClick, person }, person.cityName)) });
};
/**
...
function createBrowserRouter(routes, opts) {
  return createRouter({
    ...
    history: createBrowserHistory$1({
...
function useLinkClickHandler(to, _temp) {
  ...
  return reactExports.useCallback((event) => {
    if (shouldProcessLinkClick(event, target)) {
      event.preventDefault();
      let replace = replaceProp !== void 0 ? replaceProp : createPath$1(location) === createPath$1(path);
      navigate(to, {
        replace,
        state,
        preventScrollReset,
...
const wrapper$3 = "_wrapper_11i6b_1";
const item = "_item_11i6b_7";
const link = "_link_11i6b_11";
const linkActive = "_linkActive_11i6b_15";
const css$3 = {
  wrapper: wrapper$3,
  item,
  link,
...
const Navigation = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Nav$1, { className: css$3.wrapper, variant: "tabs", activeKey: location.pathname, children: ITEMS.map(({ to, text }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Nav$1.Item, { className: css$3.item, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { className: cn(css$3.link, { [css$3.linkActive]: to === location.pathname }), to, children: text }) }, to)) });
};
const wrapper$2 = "_wrapper_1jzq8_1";
const css$2 = {
  wrapper: wrapper$2
};
const getInitials = (email) => email.slice(0, 4).toUpperCase();
const UserInfo = reactExports.memo(({ email }) => {
  ...
  return (
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      NavDropdown$1,
      {
        className: cn(css$2.wrapper, "border-white d-flex justify-content-center align-items-center"),
        title: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white text-truncate", children: getInitials(email) }),
        menuVariant: "dark",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(NavDropdown$1.Item, { onClick: () => navigate(InternalRoutes.Logout), children: "Logout" })
      }
    )
  );
});
const Layout = ({ header, body }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$1, { fluid: true, className: "d-flex flex-column min-vh-100 min-vw-100 bg-dark text-white p-3 gap-3", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx(Row$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, { children: header }) }),
  /* @__PURE__ */ jsxRuntimeExports.jsx(Row$1, { className: "flex-grow-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, { children: body }) })
] });
const UserLayout = ({ body, showNavigation = true }) => {
  const user = useSelector(selectUser);
  if (!user)
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: InternalRoutes.Login });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Layout,
    {
      header: /* @__PURE__ */ jsxRuntimeExports.jsxs(Row$1, { className: cn({ "justify-content-end": !showNavigation }), children: [
        showNavigation && /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, { xs: "auto", className: "d-flex", children: /* @__PURE__ */ jsxRuntimeExports.jsx(UserInfo, { email: user.email }) })
      ] }),
      body
    }
  );
...
const BODY_RENDER_MAP = [
  { header: "Настройка парсинга городов", bodyRender: () => /* @__PURE__ */ jsxRuntimeExports.jsx(Layout$4, {}) },
  { header: "Обновить остатки", bodyRender: () => /* @__PURE__ */ jsxRuntimeExports.jsx(FileUpload, {}) },
  {
    header: "Редактировать количество заказываемого товара и минимальные остатки",
    bodyRender: () => /* @__PURE__ */ jsxRuntimeExports.jsx(Layout$3, {})
  },
  { header: "Редактировать информацию об ответственных за города", bodyRender: () => /* @__PURE__ */ jsxRuntimeExports.jsx(Layout$1, {}) },
  { header: "Редактировать настройки отправки почты", bodyRender: () => /* @__PURE__ */ jsxRuntimeExports.jsx(Layout$2, {}) }
];
const AdminLayout = reactExports.memo(() => /* @__PURE__ */ jsxRuntimeExports.jsx(
  UserLayout,
  {
    body: /* @__PURE__ */ jsxRuntimeExports.jsx(Accordion$1, { children: BODY_RENDER_MAP.map(({ header, bodyRender }, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Accordion$1.Item, { eventKey: index.toString(), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Accordion$1.Header, { children: header }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Accordion$1.Body, { children: bodyRender() })
    ] })) })
  }
));
const reducers$1 = { $citiesPrefixEdit, $fileUpload, $minimalLeftovers, $mailerSettings, $responsiblePersons };
const reducers = { $leftoversTable };
...
const loadSession$1 = () => call({ url: Methods.Session });
const login$1 = (data) => call({
  url: Methods.Login,
  options: {
    method: "POST",
    body: data,
...
const logout = () => call({ url: Methods.Logout, options: { method: "POST" } });
var AuthStatus = /* @__PURE__ */ ((AuthStatus2) => {
  AuthStatus2["Initial"] = "initial";
  AuthStatus2["Pending"] = "pending";
  AuthStatus2["Anonymous"] = "anonymous";
  AuthStatus2["Authenticated"] = "authenticated";
  return AuthStatus2;
})(AuthStatus || {});
const selectSessionState = (state) => state.session;
const selectIsAuthenticated = (state) => selectSessionState(state).authStatus === AuthStatus.Authenticated;
const selectIsSessionChecked = (state) => selectSessionState(state).authStatus !== AuthStatus.Initial;
const computeActionName$1 = (actionName) => `session/${actionName}`;
const setAuthStatus = createAction(computeActionName$1("setAuthStatus"));
const loadSession = createAppAsyncThunk(
  computeActionName$1("loadSession"),
  (_2, { dispatch }) => loadSession$1().then((d2) => {
    dispatch(setUser(d2));
    return d2;
  })
);
...
const initialState$1 = { authStatus: AuthStatus.Initial };
const session = createReducer(initialState$1, (builder) => {
...
const computeActionName = (actionName) => `login/${actionName}`;
const setEmail = createAction(computeActionName("setEmail"));
const setPassword = createAction(computeActionName("setPassword"));
const submit = createAppAsyncThunk(
  computeActionName("submit"),
  (_2, { getState, dispatch }) => login$1(selectEmailPassword(getState())).then((d2) => {
...
const login = createReducer(initialState, (builder) => {
  builder.addCase(setEmail, (state, { payload }) => {
    state.email = payload;
...
const selectEmail = (state) => selectLoginState(state).email;
const selectPassword = (state) => selectLoginState(state).password;
const selectIsLoading = (state) => selectLoginState(state).isLoading;
const selectEmailPassword = (state) => ({
  email: selectEmail(state),
  password: selectPassword(state)
});
const wrapper$1 = "_wrapper_rhh2d_1";
const css$1 = {
  wrapper: wrapper$1
};
const getRootReducer = (history) => combineReducers({
...
const initStore = (history) => {
  return configureStore({
    ...
    middleware: (getDefaultMiddleware2) => [
      ...
      routerMiddleware$1(history)
    ]
  });
};
const useAppDispatch = () => useDispatch();
const useActions = (actions2) => reactExports.useMemo(() => bindActionCreators(actions2, useAppDispatch()), []);
const useQueue = () => {
  const [queue, setQueue] = reactExports.useState([]);
  return reactExports.useMemo(
    () => ({
      get: () => queue[0],
      shift: () => setQueue((queue2) => {
        queue2.shift();
        return [...queue2];
      }),
      push: (item2) => setQueue((queue2) => [...queue2, item2]),
      length: () => queue.length,
...
const useLatest = (v2) => {
  const valueRef = reactExports.useRef(v2);
  reactExports.useLayoutEffect(() => {
    valueRef.current = v2;
  });
  return valueRef;
};
const useUIQueue = (updateTime, onEffect = lodashExports.noop, onTimeout = lodashExports.noop) => {
  const onEffectRef = useLatest(onEffect);
  const onTimeoutRef = useLatest(onTimeout);
  const isShowing = reactExports.useRef(false);
  const queue = useQueue();
  reactExports.useLayoutEffect(() => {
    if (isShowing.current || queue.isEmpty())
      return;
    onEffectRef.current();
...
const useEvent = (fn3) => {
  const fnRef = reactExports.useRef(fn3);
  reactExports.useLayoutEffect(() => {
    fnRef.current = fn3;
  }, [fn3]);
  return reactExports.useCallback((...args) => fnRef.current.apply(null, args), [fnRef]);
};
function useWindowEvent(type, cb2) {
  const eventCb = useEvent(cb2);
  reactExports.useEffect(() => {
...
const useShowAlert = () => {
  ...
  return reactExports.useMemo(
    () => ({
      setAlertState: (props) => queue.push(props),
      Alert: () => /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: Boolean(alertState) && /* @__PURE__ */ jsxRuntimeExports.jsx(Alert$1, { ...alertState, show: true, style: { position: "absolute", top: 0, width: "100%", left: 0 } }) })
    }),
    [alertState]
  );
};
const useShowModal = () => {
  ...
  const handleDecline = () => {
    var _a, _b;
    (_b = modalState == null ? void 0 : (_a = modalState.declineProps).onClick) == null ? void 0 : _b.call(_a);
    queue.shift();
  };
  const handleAccept = () => {
    var _a, _b;
    (_b = modalState == null ? void 0 : (_a = modalState.acceptProps).onClick) == null ? void 0 : _b.call(_a);
    queue.shift();
  };
  useWindowEvent("keyup", (e2) => {
    if (modalState) {
  ...
  return reactExports.useMemo(
    () => ({
      setModalState: (modalState2) => queue.push(modalState2),
      Modal: () => modalState ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Modal$1, { show: true, onHide: handleDecline, backdrop: "static", keyboard: false, children: [
        modalState.title && /* @__PURE__ */ jsxRuntimeExports.jsx(Modal$1.Header, { closeButton: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Modal$1.Title, { children: modalState.title }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Modal$1.Body, { children: modalState.body }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Modal$1.Footer, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { variant: "primary", onClick: handleAccept, children: modalState.acceptProps.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { variant: "secondary", onClick: handleDecline, children: modalState.declineProps.title })
        ] })
      ] }) : null
    }),
    [modalState]
...
const useFieldFocus = (elementRef, show) => {
  reactExports.useLayoutEffect(() => {
    var _a;
    if (show)
...
const useInitDownloadData = ({ downloadFn, data }) => {
  reactExports.useLayoutEffect(() => {
    if (!data)
      void downloadFn();
  }, []);
};
const wrapper = "_wrapper_1tvu4_1";
const css = {
  wrapper
};
const LoadingPage = () => /* @__PURE__ */ jsxRuntimeExports.jsx(Container$1, { fluid: true, className: "vw-100 vh-100 d-flex justify-content-center align-items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner$1, { variant: "info", className: css.wrapper }) });
const AlertErrorProvider = ({ children }) => {
  const errorsMessagesList = useSelector(selectErrorsMessagesList);
  const { cleanErrors: cleanErrors2, addAlertsSettings: addAlertsSettings2 } = useActions(actions$8);
  reactExports.useLayoutEffect(() => {
    if (errorsMessagesList.length) {
      errorsMessagesList.forEach((message) => addAlertsSettings2({ children: message, variant: "danger" }));
      cleanErrors2();
    }
  }, [errorsMessagesList]);
...
const AlertProvider = ({ children }) => {
  ...
  const { cleanAlertsSettings: cleanAlertsSettings2 } = useActions(actions$8);
  const { Alert: Alert2, setAlertState } = useShowAlert();
  reactExports.useLayoutEffect(() => {
    if (alertsSettings.length) {
      alertsSettings.forEach((settings) => setAlertState(settings));
      cleanAlertsSettings2();
    }
  }, [alertsSettings]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    children,
    /* @__PURE__ */ jsxRuntimeExports.jsx(Alert2, {})
  ] });
};
const ModalProvider = ({ children }) => {
  const modalSettings = useSelector(selectModalSettingsList);
  const { cleanModalSettings: cleanModalSettings2 } = useActions(actions$8);
  const { Modal: Modal2, setModalState } = useShowModal();
  reactExports.useLayoutEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    children,
    /* @__PURE__ */ jsxRuntimeExports.jsx(Modal2, {})
  ] });
};
...
const ProtectedRoute = ({ otherwiseRoute, type }) => {
  const isLoggedIn = useSelector(selectIsAuthenticated);
  const isAdmin = useSelector(selectIsAdmin);
  if (type === "auth" && !isLoggedIn || type === "anonymous" && isLoggedIn || type === "admin" && (!isAdmin || !isLoggedIn)) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: otherwiseRoute, replace: true });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {});
};
const getLoginPage = () => __vitePreload(() => import("./index-768ef322.js"), true ? [] : void 0).then(({ Login }) => ({ element: /* @__PURE__ */ jsxRuntimeExports.jsx(Login, {}) }));
const getIndexPage = () => __vitePreload(() => import("./index-1eec932c.js"), true ? [] : void 0).then(({ App: App2 }) => ({ element: /* @__PURE__ */ jsxRuntimeExports.jsx(App2, {}) }));
const Router = () => /* @__PURE__ */ jsxRuntimeExports.jsx(
  RouterProvider,
  {
    fallbackElement: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingPage, {}),
    router: createBrowserRouter([
      {
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(ProtectedRoute, { otherwiseRoute: InternalRoutes.Main, type: "anonymous" }),
        children: [
          {
      ...
      {
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(ProtectedRoute, { otherwiseRoute: InternalRoutes.Login, type: "auth" }),
        children: [
          {
          ...
          },
          {
            ...
            lazy: () => __vitePreload(() => import("./index-c69c88f9.js"), true ? [] : void 0).then(({ Logout }) => ({ element: /* @__PURE__ */ jsxRuntimeExports.jsx(Logout, {}) }))
          },
          {
            path: "*",
            lazy: getIndexPage
          ...
          {
            element: /* @__PURE__ */ jsxRuntimeExports.jsx(ProtectedRoute, { otherwiseRoute: InternalRoutes.Main, type: "admin" }),
            children: [
              {
                path: InternalRoutes.Admin,
                lazy: () => __vitePreload(() => import("./index-3b544021.js"), true ? [] : void 0).then(({ Admin }) => ({ element: /* @__PURE__ */ jsxRuntimeExports.jsx(Admin, {}) }))
              }
            ]
          }
        ]
...
const StoreProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Provider, { store: getStore(), children });
};
const App = () => {
  const hasSession = useSelector(selectIsSessionChecked);
  const { loadSession: loadSession2 } = useActions(actions$1);
  useInitDownloadData({ data: hasSession, downloadFn: loadSession2 });
  if (!hasSession)
    return /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingPage, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Router, {});
};
const EntryPoint = () => /* @__PURE__ */ jsxRuntimeExports.jsx(StoreProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ModalProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AlertProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AlertErrorProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) }) }) });
const style = "";
createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(EntryPoint, {}) })
);
export {
  AdminLayout as A,
  Button$1 as B,
  ...
  css$1 as c,
  Col$1 as d,
  selectLoginState as e,
  selectEmail as f,
  selectPassword as g,
  selectIsLoading as h,
  selectLeftoversList as i,
  ...
  css$5 as q,
  reactExports as r,
  selectEmailPassword as s,
  useInitDownloadData as t,
  useSelector as u,
  selectIsAdmin as v,
  reducers as w,
  createAppAsyncThunk as x,
  logout as y,
  reducers$1 as z
};
//# sourceMappingURL=index-c56b4bbb.js.map
