...
export declare const computeWebSocketSendData: (d: string | number | boolean | object | symbol | []) => string;
...
export declare const alphabeticalSort: (a: string, b: string) => 0 | 1 | -1;
export {};
