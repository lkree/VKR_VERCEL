import { GetMongooseScheme } from '../../../shared/lib/ts/index.js';
import type { leftoversModel } from '../model/index.js';
...
export type LeftoverFE = {
    ...
    leftovers: Array<Pick<Leftover['leftovers'][number], 'nomenclature' | 'leftoverAtEnd' | 'orderedCount' | 'unit'> & {
        haveToOrder: number;
    }>;
};
